...
const projects: Project[] = [
  {
    ...
    bhk: '2 BHK',
    area: '1,150 sq.ft.',
    amenities: ['Gymnasium', 'Community Hall', 'Children\'s Play Area', 'Landscaped Gardens', 'Car Parking'],
  ...
  },
  {
    ...
    bhk: '4 BHK',
    area: '3,500 sq.ft.',
    amenities: ['Dedicated Parking', 'Home Theater', 'Landscaped Gardens', 'Security Features', 'Community Hall'],
